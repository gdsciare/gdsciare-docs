...
<Callout emoji="🔥">
QBS Archive Web App has served more than **8500+** requests since its launch 
</Callout>
...
## Utsav IARE - The Events App

![](../public/images/screenshots/utsav_iare_ss.png)

<Callout emoji="👑">
This project will soon replace the Events Management System for the entire campus :)
</Callout>

This amazing app is being built as a one stop mobile application for all events being organized in the campus. With cool features like instant notifications, slick UI and much more, you are surely going to love it. This app feels great and we have deployed this app currently in Google Play Store. Soon we'll be having the iOS version out on App Store.

Key Features:

📅 Event Calendar: Browse a comprehensive calendar of events happening on your campus.

📢 Event Alerts: Get real-time notifications for your favorite events and never miss an update.

🎫 Ticketing and Registration: Secure your spot at events with easy ticket purchase or registration.

👥 Social Sharing: Share events with friends and coordinate your plans effortlessly.

📍 Interactive UI: Browse through clean and neat UI, backed by GDSC Tech

💬 Event Feedback: Leave reviews and feedback to help improve future events.

📸 Event Galleries: Relive the excitement with event photo galleries.
...
**Project Link:** [Play Store Link](https://play.google.com/store/apps/details?id=com.gdsciare.utsav) | [App Store Link](#)
...
<Callout emoji="🔥">
Weboris has served more than **7000+** requests since it's launch 
</Callout>
