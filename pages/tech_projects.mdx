...
This project is in development. Stay Tuned to be blown away :)
</Callout>

This amazing app is being built as a one stop mobile application for all events being organized in the camus. With cool features like instant notifications, slick UI and much more, you are surely going to love it. Stay tuned as we deploy this app in Android and iOS App Store.
